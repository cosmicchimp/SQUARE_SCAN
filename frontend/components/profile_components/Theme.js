        ...
        >
          <View style={{ flex: 1, backgroundColor: "rgba(0, 0, 0, 0.9) " }}>
            <View style={styles.headerBox}>
              <Text style={styles.modalTitle}>Theme Options:</Text>
            </View>
